...
async function main() {
    const res = await got("https://api.github.com/repos/ludvigalden/use-safe-force-update/releases", {
        responseType: "json",
    });
    ...
    // Add compare link
    finalMessage.push(`https://github.com/ludvigalden/use-safe-force-update/compare/${firstVersion}...${lastVersion}`);
